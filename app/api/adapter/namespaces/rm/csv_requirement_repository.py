...
class CsvRequirementRepository(Repository):
    ...
    specification_map = {
        ...
        "Specification_id": {
            "attribute": "_BaseResource__identifier",
            "oslc_property": "DCTERMS.identifier",
        },
        "Title": {
            "attribute": "_BaseResource__title",
            "oslc_property": "DCTERMS.title",
        },
        "Description": {
            "attribute": "_BaseResource__description",
            "oslc_property": "DCTERMS.description",
        },
        "Author": {
            "attribute": "_BaseResource__creator",
            "oslc_property": "DCTERMS.creator",
        },
        # RM and Custom attributes
        "Product": {
            "attribute": "_BaseResource__short_title",
            "oslc_property": "DCTERMS.shortTitle",
        },
        "Subject": {
            "attribute": "_BaseResource__subject",
            "oslc_property": "DCTERMS.subject",
        },
        "Source": {
            "attribute": "_Requirement__elaborated_by",
            "oslc_property": "OSLC_RM.elaboratedBy",
        },
        "Category": {
            "attribute": "_Requirement__constrained_by",
            "oslc_property": "OSLC_RM.constrainedBy",
        },
        "Discipline": {
            "attribute": "_Requirement__satisfied_by",
            "oslc_property": "OSLC_RM.satisfiedBy",
        },
        "Revision": {
            "attribute": "_Requirement__tracked_by",
            "oslc_property": "OSLC_RM.trackedBy",
        },
        "Target_Value": {
            "attribute": "_Requirement__validated_by",
            "oslc_property": "OSLC_RM.validatedBy",
        },
        "Degree_of_fulfillment": {
            "attribute": "_Requirement__affected_by",
            "oslc_property": "OSLC_RM.affectedBy",
        },
        "Status": {
            "attribute": "_Requirement__decomposed_by",
            "oslc_property": "OSLC_RM.decomposedBy",
        },
        # CUSTOM attributes
    ...
    def create(self, requirement):
        with open(self.csv_file_path, "a") as f:
            ...
            writer.writerow(CsvRequirementRepository.requirement_to_dict(requirement))
    ...
    def delete(self, requirement):
        ...
        with open(self.csv_file_path, "rb") as file, open(
            temp_csv_file_path, "wb"
        ) as new_file:
            fieldnames = list(CsvRequirementRepository.specification_map.keys())
            ...
            for row in csv.reader(file):
                if (
                    ...
                    != CsvRequirementRepository.read_requirement(row).identifier
                ):
                    writer.writerow(row)
    ...
    def requirement_to_dict(requirement):
        ...
        for key in CsvRequirementRepository.specification_map:
            attribute_name = CsvRequirementRepository.specification_map[key][
                "attribute"
            ]
