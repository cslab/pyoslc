...
def test_base_adapter(base_adapter):
    ...
    assert base_adapter.identifier and base_adapter.identifier != '', 'Identifier should be initialized'
    assert base_adapter.title and base_adapter.title != '', 'Title should be initialized'
...
def test_rm_adapter(rm_adapter):
    assert rm_adapter.identifier and rm_adapter.identifier == 'rmtest', 'Identifier should be initialized'
    assert rm_adapter.title and rm_adapter.title == 'RM Test', 'Title should be initialized'
...
def test_tc_adapter(tc_adapter):
    assert tc_adapter.identifier and tc_adapter.identifier == 'tctest', 'Identifier should be initialized'
    assert tc_adapter.title and tc_adapter.title == 'QM Test', 'Title should be initialized'
